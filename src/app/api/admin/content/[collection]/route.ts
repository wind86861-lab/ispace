...
const COLLECTIONS: Record<string, { seed: Entity[]; validate: (i: unknown, e?: never) => Entity }> = {
  ...
  services: {
    seed: seedServices,
    validate: (i, e) => validateService(i, e as ClientService | undefined),
  },
  productFeatures: {
    seed: seedFeatures,
    validate: (i, e) => validateProductFeature(i, e as ProductFeature | undefined),
  },
  /* Yagona yozuv — ombor massiv bilan ishlagani uchun bitta elementli. */
  contact: {
    seed: [seedContact],
    validate: (i, e) => validateContact(i, e as SiteContact | undefined),
  },
};
